...
- [ ] Product-layer gates are selected from realistic failure modes.
- [ ] The exact pull-request head receives a real CodeQL initialization and analysis upload.
- [ ] Skipped application/database/browser gates are explained rather than presented as executed.
