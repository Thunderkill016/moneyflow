...
Select evidence from `docs/engineering/RISK_PROPORTIONAL_DELIVERY.md` based on realistic failure modes.
...
State why each omitted gate is not applicable. A successful build does not prove database isolation, browser behavior, provider configuration or production behavior.
