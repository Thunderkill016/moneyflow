...
- [ ] T090 Run the risk-selected exact-head verification
  ...
  - Evidence: exact commands, run links/artifacts and pass/fail/not-applicable reasons
  - Stop condition: any required gate fails or did not run
...
- [ ] T093 Prepare ready-for-review handoff
  ...
  - Stop condition: merge, deploy or production write is attempted by the agent
