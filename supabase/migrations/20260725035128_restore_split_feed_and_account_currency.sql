-- Restore two repository migrations that were skipped in the production migration history.
-- This repair is intentionally ordered after recurring-income migrations so the final
-- transaction_feed retains both recurring-payment metadata and split expense lines.
