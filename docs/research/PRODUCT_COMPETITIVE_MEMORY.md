...
- **Strong**: core, mature product behavior.
- **Partial**: available with limits or not central.
- **No/Deferred**: absent or intentionally outside MoneyFlow scope.

Commercial-product status is based on official surfaces reviewed for this dated snapshot.

| Capability | MoneyFlow | Money Lover | MISA | YNAB | Monarch | Copilot | Wallet | Rocket Money | Actual | Firefly III | Sheets |
|---|---|---|---|---|---|---|---|---|---|---|---|
| Vietnamese-first | **Strong** | **Strong** | **Strong** | No | No | No | Partial | No | No | No | User-built |
| Manual entry | **Strong** | **Strong** | **Strong** | **Strong** | Partial | Partial | **Strong** | Partial | **Strong** | **Strong** | **Strong** |
| Multiple accounts | **Strong** | **Strong** | **Strong** | **Strong** | **Strong** | **Strong** | **Strong** | **Strong** | **Strong** | **Strong** | User-built |
| Structural transfers | **Strong** | Supported | Public detail unclear | **Strong** | **Strong** | **Strong** | **Strong** | Classification-led | **Strong** | **Strong** | User-built |
| Reconciliation | **No — next** | Not established here | Not established here | **Strong** | Not central | Not established here | Balance confirmation; full depth unverified | Not central | **Strong** | Accounting-oriented | Manual |
| Category budgets | **Strong basic** | **Strong** | **Strong** | **Strong method** | **Strong** | **Strong** | **Strong** | **Strong** | **Strong envelope** | **Strong** | User-built |
| Recurring / bills | **Strong basic** | **Strong** | Marketed | **Strong** | **Strong** | **Strong** | **Strong** | **Strong focus** | **Strong** | **Strong** | User-built |
| Savings goals | **Strong basic** | **Strong** | **Strong** | Targets | **Strong** | Available | **Strong** | Automated goals | Planning-oriented | Piggy banks | User-built |
| Controlled import | **Strong** | Available | Public detail unclear | **Strong** | **Strong** | **Strong** | **Strong** | Aggregation-led | **Strong** | **Strong** | Manual |
| User rules | Local parse rules; authenticated persistence deferred | Automation surfaces | AI/automation marketed | Automation | **Strong** | Rules | **Strong** | Detection | **Strong ordered** | **Strong ordered** | Formulas |
| Review state | Inbox-specific | Not established here | Not established here | Approval/cleared | Review status | **Strong To Review** | Confirmation | Action review | Cleared/locked | Accounting review | Manual |
| Export / portability | **Strong CSV** | Premium export | Excel/PDF | Available | Available | **Strong CSV** | Premium formats | Not core identity | **Strong/self-host** | **Strong/API** | Native |
| Direct data ownership | Hosted + export | Cloud | Cloud | Cloud | Cloud | Cloud | Cloud | Cloud | **Strong local/self-host** | **Strong self-host** | **Strong file ownership** |
| Household sharing | Deferred | Wallet sharing | Marketed | YNAB Together | **Strong** | Limited fit | **Strong** | Shared accounts | Technical multi-user | Possible but complex | Shared file |
| Bank sync | Non-goal now | Marketed | Marketed | Regional | Core | Core | Core premium | Core | Optional | External importer | No |
| AI/OCR/advice | Non-goal now | Marketed features | Marketed | Not relevant | Automation | AI categorization | OCR direction | Algorithms/services | Rules, not advice | Rules, not advice | User-built |
...
- Information hierarchy can separate tracking, planning and long-term views.
