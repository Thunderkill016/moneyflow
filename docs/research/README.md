...
## Active reference maps and cumulative ledgers
...
**Lưu ý:** Bộ docs này là luật định vị **thu chi cá nhân**. Autopilot code (`AGENT_BACKLOG`) từng nghiêng Inbox — ưu tiên task khớp Phần F/H của file 05 và luôn đối chiếu `docs/product/PRINCIPLES.md` mới hơn.
