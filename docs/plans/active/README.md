...
**Last reconciled:** 2026-08-26 (post-#475)
**Current main baseline:** `2da83e10155c17accfc7ca01b6f3e184a164d182` (PR #475 squash-merged)
...
No agent-executable product/governance slice is selected in this post-merge projection. PR #477 is candidate-only until its exact head has required checks, resolved review threads, unchanged base/main and an owner squash merge.
