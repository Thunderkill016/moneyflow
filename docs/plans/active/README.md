...
Only deliberately started, non-trivial work belongs here. This registry is the
authoritative filename-level answer to “what is executing now”; GitHub issues and
pull requests remain the dynamic status source.
...
| `moneyflow-codex-dispatcher-v1.md` | active child delivery | bounded local Codex dispatcher hardening only (#379) |
