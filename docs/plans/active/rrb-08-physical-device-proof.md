...
## Optional diagnostics on the physical device

Diagnostics are optional; direct physical observation is the required layer.
...
These tools help capture console/network/layout diagnostics. They are not substitutes for observing the real phone itself.
