...
| A4 | **Write-capability spec research** — ✅ spec authored: `docs/plans/active/617-write-capability-spec.md` (issue #617). Decision: agent writes enter as **candidates** (`source: "agent"`, idempotency via `sourceExternalId`, human approve in Inbox); direct-ledger auto-post deferred + separately gated. **Không code** | owner authorized G2 (2026-09-20); spec awaits owner review → G5 | 3 |
