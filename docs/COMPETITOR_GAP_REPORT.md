...
|-------|-------------------|------|
| `transfer_integrity` | Firefly + Actual (transfer ≠ expense) | ✅ |
| `fast_entry` | Money Lover + Ivy (quick add) | ✅ |
| `overview_dashboard` | Monarch (overview dashboard) | ✅ |
| `safe_to_spend` | PocketGuard (safe-to-spend) | ✅ |
...
| `soft_delete` | Consumer fintech undo | ✅ |
| `error_parity` | Trust UX (all PFM leaders) | ✅ |
| `e2e_critical_path` | Ship quality (all serious products) | ✅ |
| `pwa_home` | G5 PWA | ✅ |
