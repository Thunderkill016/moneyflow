...
const copy = {
  login: {
    title: "Đăng nhập",
    description: "Dùng tài khoản MoneyFlow của bạn để tiếp tục.",
    submit: "Đăng nhập",
  },
  register: {
    title: "Tạo tài khoản",
    description:
      "Bắt đầu với một tài khoản tiền mặt, ngân hàng hoặc ví điện tử.",
    submit: "Tạo tài khoản",
  },
  forgot: {
    title: "Quên mật khẩu?",
    description:
      "Nhập email đã đăng ký. MoneyFlow sẽ gửi liên kết đặt lại mật khẩu.",
    submit: "Gửi liên kết",
  },
  update: {
    title: "Đặt mật khẩu mới",
    description: "Mật khẩu mới cần ít nhất 12 ký tự.",
