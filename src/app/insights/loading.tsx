export default function Loading() {
  return (
    <main className="dashboard route-loading" aria-label="Đang tải Insights" aria-busy="true">
      <section className="welcome-row">
        <div>
          <div className="loading-line" style={{ width: "120px", height: "14px" }} />
          <div
            className="loading-line wide"
            style={{ width: "240px", height: "32px", marginTop: "12px" }}
          />
          <div
            className="loading-line"
            style={{ width: "320px", height: "16px", marginTop: "8px" }}
          />
        </div>
      </section>
